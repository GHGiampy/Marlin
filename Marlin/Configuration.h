...
#define STRING_CONFIG_H_AUTHOR "(Giampy, ProUI-Marlin)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    // Ender 3 v2
    #define DEFAULT_Kp  28.72 // My tune:  22.20
    #define DEFAULT_Ki   2.62 // My tune:   1.08
    #define DEFAULT_Kd  78.81 // My tune: 114.00
  #endif
#endif
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN                PB0 // PB2      // LED driving pin (PB0=BLTouch out)
  //#define NEOPIXEL2_TYPE  NEOPIXEL_TYPE
  //#define NEOPIXEL2_PIN               5
  #define NEOPIXEL_PIXELS             133 // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
